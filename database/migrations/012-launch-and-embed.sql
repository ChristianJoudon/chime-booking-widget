...
CREATE TABLE IF NOT EXISTS chime_app.launch_settings (
  ...
  allowed_domains text[] NOT NULL DEFAULT ARRAY['127.0.0.1:4374', 'localhost:4374']::text[],
  loader_url text NOT NULL DEFAULT 'http://127.0.0.1:4374/embed/chime-widget.js',
  stylesheet_url text NOT NULL DEFAULT 'http://127.0.0.1:4374/embed/chime-widget.css',
  hosted_base_url text NOT NULL DEFAULT 'http://127.0.0.1:4374/book.html',
  api_base_url text NOT NULL DEFAULT 'http://127.0.0.1:8887/api/chime',
